 ...
 */
final class Version20200303110003 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE fos_user ADD role_id INT NOT NULL, ADD profil_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE fos_user DROP role_id, DROP profil_id');
    }
}
