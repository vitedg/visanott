 ...
 */
final class Version20200302110831 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE droit_access (id INT AUTO_INCREMENT NOT NULL, droit_import TINYINT(1) NOT NULL, droit_admin TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE fos_user ADD role_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE fos_user DROP role_id');
    }
}
